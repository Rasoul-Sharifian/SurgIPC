...
for frame_number = [1:125];
    path_rgbimgs = ['../1_DataPreparation/' data_name '/Color/'];

    for lambda = 940
        tic
        
        Image_path = [path_rgbimgs sprintf('%03d', frame_number) '.png'];
        ...
        folderName = [ data_name '/img_flat_gs' num2str(gridsize),'/Frame_' num2str(frame_number)];
